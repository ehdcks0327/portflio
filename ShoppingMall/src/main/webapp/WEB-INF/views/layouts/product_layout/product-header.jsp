...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand" href="/main/">중고 거래 사이트_Test</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="/main/product/call_product">About</a>
        </li>
        <li class="nav-item">
...
<!--           <a class="nav-link" href="/main/product/call_productList">Services</a> -->
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle custom-control-after" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <a class="dropdown-item" href="#sign-in" data-toggle="modal">
         	로그인
  		  </a>
  		  <div class="dropdown-divider"></div>
  		  <a class="dropdown-item" href="#sign-up" data-toggle="modal">
  		  	회원가입
  		  </a>
		  </sec:authorize>
		  <sec:authorize access="hasRole('ROLE_ADMIN')">
		  <a class="dropdown-item" href="/main/admin/">
         	관리자 메뉴
  		  </a>
		  <div class="dropdown-divider"></div>
		  </sec:authorize>
		  <sec:authorize access="isAuthenticated()">
		  <a class="dropdown-item" href="#sign-out" data-toggle="modal">
         	로그아웃
  		  </a>
		  </sec:authorize>
